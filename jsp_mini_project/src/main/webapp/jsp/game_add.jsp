	            ...
	            <li>
	                ...
	                <span>
	                    <textarea rows="10" cols="80" name="contents" required
							placeholder="※작성법: 처음엔 '...社에서 만든~'으로 작성. 여기서 ...엔 회사명을 넣으며, 반드시 社 입력할 것."></textarea>
	                </span>
	            </li>
	        </ul>
	            <div class="text-center">
	                <!-- <input type="button" value="등록하기" class="login-btn join-btn" onclick="fnCheck()"> -->
	                <input type="submit" value="등록하기" class="login-btn join-btn" formaction="game_add_view.jsp">
...
<script>
	...
	function itemCheck() {
    	...
    	pop = window.open("game_item_check.jsp?itemNo=" + itemNo, "item", "width=520, height=130, top=400, left=770");
	}
