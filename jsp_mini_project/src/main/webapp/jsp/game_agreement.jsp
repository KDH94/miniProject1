...
<body>
    <div id="container">
        ...
        <div class="container" style="position: relative; top: -100px;">
            <div class="context-default context-title" style="font-size: 20px;">이용 약관</div>
            ...
            <div class="context-default">
                ...
                표준약관 제10023호
                <br><br>
                이 약관은 KDH 회사(전자거래 사업자)가 운영하는 KDH 게임즈 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
                ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」
                <br><br><br><br>
                제2조(정의)
                <br><br>
                ① "몰"이란 KDH 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                ...
                ③ 사업종목의 전환, 사업의 포기, 업체간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 "몰"은 제8조에 정한 방법으로 이용자에게 통지하고 당초 "몰"에서 제시한 조건에 따라 소비자에게 보상합니다. 다만, "몰"이 보상기준 등을 고지하지 아니한 경우에는 이용자들의 마일리지 또는 포인트 등을 "몰"에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.
                <br><br><br><br>
                제6조(회원가입)
                <br><br>
                ...
                <br><br><br><br>
                제25조(포인트, 쿠폰 제도의 운영 및 이용)
                <br><br>
                ① "몰"은 포인트, 쿠폰을 부여 및 제도에 따라 운영할 수 있습니다.
                ② "포인트"란 "몰"이 구매 적립, 이벤트 등에 따라 회원에게 부여하는 할인수단을 말합니다.
                ③ "쿠폰"이란 "몰"의 정책에 따라 포인트 적립 또는 일정금액/비율을 할인 받을 수 있는 수단을 말합니다.
                ④ 포인트는 재화 등을 구매 시 단독으로 또는 다른 결제수단과 결합하여 사용할 수 있으나, 사전에 "몰"에서 사용이 불가능하다고 고지한 재화에 대해서는 사용을 할 수 없습니다.
                ⑤ 포인트의 획득, 사용 방법 등은 마케팅 및 기타 프로모션 등을 통하여 지급되거나 사전특약(사전 안내 포함)이 있는 경우 유효기간은 각각 별도로 설정될 수 있으며, 별도의 세부이용지침에 따릅니다.
                ⑥ 회원 탈퇴 시 기존 포인트/쿠폰은 소멸하며, 탈퇴 후에는 유효기간 내라고 하더라도 사용이 불가합니다.
                ⑦ 회원은 포인트/쿠폰을 본인의 거래에 한하여 이용할 수 있으며, 타인에게 매매 또는 양도 등의 행위를 할 수 없습니다.
                ⑧ "몰"에서 제공한 포인트/쿠폰은 "몰"에서 제공하는 서비스 내에서만 이용에 가능하며, 현금으로의 전환은 불가합니다.
                ⑨ 회원이 포인트/쿠폰을 부당 또는 부정하게 취득한 경우 회원은 이를 사용할 수 없으며, 이로 인해 발생하는 모든 법률적인 책임을 부담합니다. 또한 "몰"은 부당, 부정하게 취득한 회원의 포인트/쿠폰의 회수, 계정/주문내역 삭제 및 형사 고발 등 기타 필요한 조치를 취할 수 있습니다.
                ⑩ "몰"은 포인트의 적립 및 사용을 위하여 필요한 최소한의 정보 (아이디, 이메일 주소, 기타 회원의 식별을 위한 정보)를 제공하거나 받을 수 있습니다.
                <br><br><br><br>
                부칙
                <br><br>
